<%@ Page Language="C#" AutoEventWireup="true" CodeFile="signup1.aspx.cs" Inherits="jobpro_signup1" %>
       ...
       <td>
         <div class="accordion2">
           <table width="1000" border="0" cellspacing="0" cellpadding="0" 
                 style="height: 1272px">
             <tbody><tr>
               <td class="style2" valign="top" align="left" colspan="5">
                     ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <asp:Panel ID="Panel1" runat="server" style="margin-bottom: 140px">
                       <br />
                       &nbsp;<asp:Panel ID="Panel2" runat="server" BorderStyle="Solid" BorderWidth="3px" 
                           Height="1018px" HorizontalAlign="Center" style="margin-left: 56px" 
                           Width="848px">
                           <table align="center" cellspacing="9">
                               <tr>
                                   <td align="left" class="style7" height="30" valign="top" width="190">
                                       &nbsp;</td>
                                   <td align="left" class="style6" height="30" valign="top" width="190">
                                       &nbsp;</td>
                               </tr>
                               <tr>
                                   <td align="left" class="style7" height="30" valign="top" width="190">
                               ...
                               <tr>
                                   <td align="left" class="style7" height="30" valign="top" width="190">
                                       <asp:Label ID="Label4" runat="server" Text="Company Login Name :"></asp:Label>
                                   </td>
                                   <td align="left" class="style6" height="30" valign="top" width="190" 
                                       xml:lang="250">
                                       <asp:TextBox ID="comp_login" runat="server" Width="175px"></asp:TextBox>
                                   </td>
                               </tr>
                               <tr>
                                   <td align="left" class="style7" height="30" valign="top" width="190">
                                       <asp:Label ID="Label31" runat="server" Text="Company Name :"></asp:Label>
                                   </td>
                                   <td align="left" class="style6" height="30" valign="top" width="190" 
                                       xml:lang="250">
                                       <asp:TextBox ID="comp_login1" runat="server" Width="175px"></asp:TextBox>
                                   </td>
                               </tr>
                               <tr>
                                   <td align="left" class="style7" height="30" valign="top" width="190">
                                       <asp:Label ID="Label22" runat="server" Text="Company Type :"></asp:Label>
                                   </td>
                                   <td align="left" class="style6" height="30" valign="top" width="190" 
                                       xml:lang="250">
                                       <asp:TextBox ID="comp_type" runat="server" Width="175px"></asp:TextBox>
                                   </td>
                               </tr>
                               <tr>
                                   <td align="left" class="style7" height="30" valign="top" width="190">
                                       <asp:Label ID="Label5" runat="server" Text="Registraion Code :"></asp:Label>
                                   </td>
                                   <td align="left" class="style6" height="30" valign="top" width="190" 
                                       xml:lang="250">
                                       <asp:TextBox ID="comp_reg" runat="server" Width="250px"></asp:TextBox>
                                   </td>
                               </tr>
                               <tr>
                                   <td align="left" class="style7" height="30" valign="top" width="190">
                                   ...
                                   <td align="left" class="style6" height="30" valign="top" width="190" 
                                       xml:lang="250">
                                       <asp:TextBox ID="dvcode" runat="server" Rows="3"></asp:TextBox>
                                   </td>
                               </tr>
                               <tr>
                                   <td align="left" class="style7" height="30" valign="top" width="190">
                                       <asp:Label ID="Label6" runat="server" Text="D.V.  CODE  :"></asp:Label>
                                   </td>
                                   <td align="left" class="style6" height="30" valign="top" width="190" 
                                       xml:lang="250">
                               ...
                               <tr>
                                   ...
                                   <td align="left" class="style6" height="30" valign="top" width="190" 
                                       xml:lang="250">
                                       <asp:TextBox ID="comp_name2" runat="server"></asp:TextBox>
                                   </td>
                               </tr>
                               <tr>
                                   <td align="left" class="style7" height="30" valign="top" width="190">
                                       <asp:Label ID="Label30" runat="server" Text="Company Name :"></asp:Label>
                                   </td>
                                   <td align="left" class="style6" height="30" valign="top" width="190" 
                                       xml:lang="250">
                               ...
                               <tr>
                                   ...
                                   <td align="left" class="style6" height="30" valign="top" width="190" 
                                       ...
                                       <asp:DropDownList ID="state" runat="server">
                                           <asp:ListItem>Amahadnagar </asp:ListItem>
                                           <asp:ListItem>kolhapure</asp:ListItem>
                                           <asp:ListItem>Aurangabaad</asp:ListItem>
                               ...
                               <tr>
                                   ...
                                   <td align="left" class="style6" height="30" valign="top" width="190" 
                                       xml:lang="250">
                                       <asp:TextBox ID="password" runat="server" TextMode="Password" Width="175px"></asp:TextBox>
                                   </td>
                               </tr>
                               <tr>
                                   <td align="left" class="style7" height="30" valign="top" width="190">
                                   ...
                                   <td align="left" class="style6" height="30" valign="top" width="190" 
                                       xml:lang="250">
                                       <asp:TextBox ID="repass" runat="server" Rows="4" TextMode="Password" 
                               ...
                               <tr>
                                   ...
                                   <td align="left" class="style6" height="30" valign="top" width="190" 
                                       xml:lang="250">
                                       <asp:DropDownList ID="state0" runat="server">
                                           <asp:ListItem>whats your nick name</asp:ListItem>
                                           <asp:ListItem>who is your best freind</asp:ListItem>
                               ...
                               <tr>
                                   <td align="left" class="style7" height="30" valign="top" width="190">
                                       <asp:Label ID="Label33" runat="server" Text="Upload Logo  : "></asp:Label>
                                   </td>
                                   <td align="left" class="style6" height="30" valign="top" width="190" 
                                       xml:lang="250">
                               ...
                               <tr>
                                   <td class="style7" valign="top" width="190">
                                       &nbsp;</td>
                                   <td class="style6" valign="top" width="190">
                                       &nbsp;</td>
                               </tr>
                               <tr>
                                   <td class="style8" colspan="2" height="50" valign="top" width="190">
                                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                       <br />
                                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 ...
                 <tr>
               <td class="style2" valign="top" colspan="5">
                   &nbsp;</td>
                </tr>
