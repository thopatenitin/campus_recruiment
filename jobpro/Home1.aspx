<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Home1.aspx.cs" Inherits="jobpro_Home1" %>
    ...
    <td valign="top" 
      ...
      <tr>
        ...
        <table width="200" border="0" align="right" cellpadding="0" cellspacing="0">
         ...
         <tr>
           <td align="left">
                       <asp:HyperLink ID="HyperLink1" runat="server">Log Out</asp:HyperLink>
                       </td>
     </tr>
         </tbody></table>
     ...
     <tbody><tr>
       <td>
         <div class="accordion2">
           <table width="1000" border="01" cellspacing="0" cellpadding="0">
             <tbody><tr>
...
<!-- End Form For Student Login -->
        ...
        <tbody><tr>
                          ...
                          &nbsp;<div 
                              ...
                              <asp:Image ID="Image1" runat="server" ImageUrl="~/images/logo/th (12).jpg" 
                                  Width="191px" />
                        </td>
        </tr>
          <tr>
         ...
         <td height="30" bgcolor="#e7e6e4" style="padding:0px 7px 0px 7px;"><span class="lftnavlink"><b><f3>Mock Test</f3></b></span> </td>
          ...
          <tr>
            <td height="30" style="padding:0px 7px 0px 7px;">
                ...
                <td class="style1" colspan="3" valign="top"><div id="pane2"><table width="300" border="0" align="center" cellpadding="10" cellspacing="0">
                  <tbody><tr>
...
<!-- End Form For College Login -->
                  ...
                  <tr>
                    ...
                    <asp:Panel ID="Panel1" runat="server" BorderWidth="1px" Height="147px">
                        &nbsp;</a><asp:Label ID="Label4" runat="server" 
    Font-Size="14pt" Text="Well Come  "></asp:Label>
                        &nbsp;&nbsp;&nbsp;
                        <asp:Label ID="Label8" runat="server" Font-Italic="True" 
    Font-Size="15pt" Text="Ferrari"></asp:Label>
                        <br />
                        <br />
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Label ID="Label5" runat="server" Font-Size="8pt" 
    Text="Plot No :12/B76  Industrial Park"></asp:Label>
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Label ID="Label6" runat="server" Font-Size="8pt" 
    Text="Navi Mumbai  400 709"></asp:Label>
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Label ID="Label7" runat="server" Font-Size="8pt" 
    Text="Maharashtra"></asp:Label>
                        <br />
                    </asp:Panel>
                    <br />
                    <br />
                    ...
                    <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:ImageButton ID="ImageButton1" runat="server" BorderWidth="1px" 
                        ImageUrl="~/images/logo/th (12).jpg" />
                    <br />
                    <br />
                 </td>
                <td width="320" class="style1" align="center" valign="top"><div id="pane3"><table width="300" border="0" align="center" cellpadding="8" cellspacing="0">
                  <tbody><tr>
...
<!-- End Form For Corporate Login -->
  ...
  <div style="float:right; font-weight:bold; margin:0px; padding:0px;">For any feedback <a href="" style="color:#FFF;">Contact us</a></div></td>
                  ...
                  </tbody></table></div>&nbsp;</a><asp:Calendar ID="Calendar1" runat="server">
                    </asp:Calendar>
                    <br />
                    <asp:Image ID="Image5" runat="server" ImageUrl="~/images/banner_vskill.gif" />
                 </td>
                </tr>
              
           
              <tr>
                <td class="style3"><map name="Map" id="Map"><area shape="rect" coords="8,64,67,94" href=""><area shape="poly" coords="1,0,321,2,318,96,138,94,136,57,2,57" href="" >
&nbsp;</map></td>
                <td>&nbsp;</td>
                <td valign="top">
                    </a></td>
