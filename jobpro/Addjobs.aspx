<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Addjobs.aspx.cs" Inherits="jobpro_Addjobs" %>
...
<!-- End Form For Student Login -->
                   ...
                   <table style="border-top: 1px solid rgb(146, 146, 146); border-left: 1px solid rgb(146, 146, 146); border-bottom: 1px solid rgb(146, 146, 146); width: 222px;" 
                       border="0" cellpadding="0" cellspacing="0">
        <tbody><tr>
                          <td align="center" bgcolor="#e7e6e4" height="165" class="style9">
                          &nbsp;<div 
                                  style="float:left; position:absolute; margin-top:-20px; width:163px; background:url(http://media.monstercollege.in/images/bg_1.png); padding:5px; text-align:right; cursor:pointer; top: 318px; left: 151px; height: 15px;" 
                              ...
                              <asp:Image ID="Image1" runat="server" ImageUrl="~/images/logo/download (3).jpg" 
                                  Width="191px" />
                        </td>
        </tr>
          <tr>
            <td height="30" style="padding:0px 7px 0px 7px;" class="style9"><a href="http://student.monstercollege.in/stu_resume.html?rand=1430239790" class="lftnavlink">Profile</a></td>
          </tr>
                  <tr>
            <td height="30" bgcolor="#e7e6e4" style="padding:0px 7px 0px 7px;" class="style9"><div style="float:left; "><a href="http://student.monstercollege.in/career_services/career_services.html?.rand=1430239790&service=VS" class="lftnavlink">Career Services</a></div></td>
          </tr>
                  <tr>
            <td height="30" bgcolor="#e7e6e4" style="padding:0px 7px 0px 7px;" class="style9"><div style="float:left; "><a href="http://student.monstercollege.in/assessment.html?rand=1430239790" class="lftnavlink">Assessment</a></div></td>
          </tr>
                   <tr>
            <td height="30" bgcolor="#e7e6e4" style="padding:0px 7px 0px 7px;" class="style9"><div style="float:left; "><a href="http://student.monstercollege.in/notification.html?rand=1430239790" class="lftnavlink">Updates</a></div></td>
          </tr>
          <tr>
            <td height="30" bgcolor="#e7e6e4" style="padding:0px 7px 0px 7px;" class="style9"><div style="float:left; "><a href="http://student.monstercollege.in/my_messages.html?rand=1430239790" class="lftnavlink">Messaging</a></div></td>
          </tr>
                  <tr>
            <td height="30" bgcolor="#e7e6e4" style="padding:0px 7px 0px 7px;" class="style9">
                <a href="http://student.monstercollege.in/applied_history.html?rand=1430239790" class="lftnavlink">History</a></td>
          </tr>
          <tr>
            <td height="30" bgcolor="#e7e6e4" style="padding:0px 7px 0px 7px;" class="style9"><a href="http://student.monstercollege.in/website.html?rand=1430239790" class="lftnavlink">Know More</a></td>
          </tr>
         ...
         <td height="30" bgcolor="#e7e6e4" style="padding:0px 7px 0px 7px;"><span class="lftnavlink"><b><f3>Mock Test</f3></b></span> </td>
          ...
          <tr>
            <td height="30" style="padding:0px 7px 0px 7px;" class="style9">
                <asp:Image ID="Image4" runat="server" ImageUrl="~/images/banner_vskill.gif" />
              </td>
          </tr>
      </tbody></table></td>
                <td class="style1" colspan="4" valign="top"><div id="pane2"><table width="300" border="0" align="center" cellpadding="10" cellspacing="0">
                  <tbody><tr>
...
<!-- End Form For Corporate Login -->
  ...
  <div style="float:right; font-weight:bold; margin:0px; padding:0px;">For any feedback <a href="" style="color:#FFF;">Contact us</a></div></td>
                  ...
                  </tbody></table></div>&nbsp;</a><table border="2">
    <tr>
    
        
    <td class="style5" width="850"><table width="840"><tr>
    <td valign="top" width="200" align="center" class="style10" colspan="2" 
            style="text-decoration: underline">
        &nbsp;<span class="style11">Job Requirment Form</span><br />
        <br />
 </td>
        </tr>
        <tr>
    <td valign="top" width="200" style="font-size: small">
        <asp:Label ID="Label22" runat="server" Text="Job Type :"></asp:Label>
        <br />
        <br />
 </td>
    <td valign="top" class="style4">
        <asp:TextBox ID="jobtype" runat="server" Width="175px" 
            ></asp:TextBox>
</td>
        </tr>
        <tr>
    <td valign="top" width="200" style="font-size: small">
        <asp:Label ID="Label4" runat="server" Text="Job Profile :"></asp:Label>
    ...
    <td valign="top" class="style4">
        <asp:DropDownList ID="jobprofile" runat="server">
            <asp:ListItem>SENIOR EXICUTIVE</asp:ListItem>
            <asp:ListItem>GENRAL MANAGER</asp:ListItem>
            <asp:ListItem>TECHNICAL EXICUTIVE OFFICER</asp:ListItem>
        ...
        <tr>
    <td valign="top" width="200" style="font-size: small">
        <asp:Label ID="Label5" runat="server" Text="Required  Qualification :"></asp:Label>
        <br />
        <br />
 </td>
    <td valign="top" class="style4">
        <asp:DropDownList ID="req_quali" runat="server">
            <asp:ListItem>BACHLER OF COMMERCE</asp:ListItem>
            <asp:ListItem>BACHLER OF ENGINEERING</asp:ListItem>
            <asp:ListItem>BACHLER OF SCIENCE </asp:ListItem>
        </asp:DropDownList>
        ...
        <tr>
    <td valign="top" width="200" style="font-size: small">
        <asp:Label ID="Label6" runat="server" Text="Other Qualification :"></asp:Label>
        <br />
 </td>
    <td valign="top" class="style4">
        <asp:TextBox ID="other_qua" runat="server" Rows="3" TextMode="MultiLine" ></asp:TextBox>
</td>
        </tr>
        <tr>
    <td valign="top" width="200" style="font-size: small">
    ...
    <td valign="top" class="style4">
        <asp:TextBox 
            ID="comp_name" runat="server" Width="250px" ></asp:TextBox>
</td>
        </tr>
        <tr>
    <td valign="top" width="200" style="font-size: small">
    ...
    <td valign="top" width="200" style="font-size: small">
        ...
        <asp:Label ID="Label24" runat="server" Text="LandMark :"></asp:Label>
        <br />
        <br />
 </td>
    <td valign="top" class="style4">
        <asp:TextBox ID="landmark" runat="server" ></asp:TextBox>
</td>
        </tr>
        <tr>
    <td valign="top" width="200" style="font-size: small">
    ...
    <td valign="top" class="style4">
        <asp:DropDownList ID="state" runat="server">
            ...
            <asp:ListItem>TAMIL NAADU</asp:ListItem>
        ...
        <tr>
    <td valign="top" width="200" style="font-size: small">
        <asp:Label ID="Label27" runat="server" Text="Pin Code :"></asp:Label>
        <br />
        <br />
 </td>
    <td valign="top" class="style4">
        <asp:TextBox ID="pin_code" runat="server" ></asp:TextBox>
</td>
        </tr>
        <tr>
    <td valign="top" width="200" style="font-size: small">
    ...
    <td valign="top" class="style4">
        <asp:TextBox ID="email_id" runat="server" Rows="4" Width="225px"></asp:TextBox>
</td>
        </tr>
        <tr>
    <td valign="top" width="200" style="font-size: small">
        <asp:Label ID="Label29" runat="server" Text="Web Site :"></asp:Label>
        <br />
        <br />
 </td>
    <td valign="top" class="style4">
        <asp:TextBox ID="website" runat="server" Width="225px"></asp:TextBox>
</td>
        </tr>
        <tr>
    <td valign="top" width="200" style="font-size: small">
    ...
    <td valign="top" class="style4">
        <asp:RadioButtonList ID="experiance" runat="server" 
            RepeatColumns="3" >
    ...
    <td valign="top" class="style4">
        <asp:TextBox ID="exp_month" runat="server" Rows="5"></asp:TextBox>
</td>
        </tr>
        <tr>
    <td valign="top" width="200" style="font-size: small">
    ...
    <td valign="top" class="style4">
        <asp:TextBox ID="exp_detail0" runat="server" Rows="5" TextMode="MultiLine"></asp:TextBox>
</td>
        </tr>
        <tr>
    <td valign="top" width="200" style="font-size: small">
    ...
    <td valign="top" class="style4">
        <asp:TextBox ID="sallery0" runat="server" Rows="5"></asp:TextBox>
</td>
        </tr>
        <tr>
    <td valign="top" width="200" style="font-size: small">
    ...
    <td valign="top" class="style4">
        <asp:TextBox ID="sallery" runat="server" Rows="5"></asp:TextBox>
</td>
        </tr>
        <tr>
    <td valign="top" width="200" style="font-size: small">
        <asp:Label ID="Label9" runat="server" Text="Upload Company Logo :"></asp:Label>
        <br />
        <br />
 </td>
    <td valign="top" class="style4">
        ...
        <tr>
    <td valign="top" width="200" align="center" colspan="2">
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button1" 
            runat="server" Text="Proceed" onclick="Button1_Click" 
             />
 </td>
        </tr>
    </table></td></tr>
                      ...
                      <td height="100" valign="top"><table width="581" border="0" cellspacing="0" cellpadding="0" align="center">
                        <tbody><tr>
                          ...
                          <td width="74"><div id="icon_gprs"><a href="" target="_blank">
                              <img src="../images/logo/spacer.gif" height="72" width="74" 
                                  style="border=none;" border="0"></a></div></td>
                          </tr>
                        </tbody></table></td>
                    </tr>
