<%@ Page Language="C#" AutoEventWireup="true" CodeFile="profile.aspx.cs" Inherits="CampusRecruiment.users.profile" %>
...
<table width="1050" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody><tr>
    <td valign="top" 
          ...
          bgcolor="White"><table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
      <tbody><tr>
...
<!-- End Form For Student Login -->
                   ...
                   <table style="border-top: 1px solid rgb(146, 146, 146); border-left: 1px solid rgb(146, 146, 146); border-bottom: 1px solid rgb(146, 146, 146);" border="0" cellpadding="0" cellspacing="0" width="200">
        <tbody><tr>
                          <td align="center" bgcolor="#e7e6e4" height="165">
                          &nbsp;<div 
                                  style="float:left; position:absolute; margin-top:-20px; width:163px; background:url(http://media.monstercollege.in/images/bg_1.png); padding:5px; text-align:right; cursor:pointer; top: 334px; left: 100px; height: 15px;" 
                                  id="tr_logo2" class="txt_white f12 bold"><a href="http://student.monstercollege.in/upload_image.html?id=1647458" class="mclinks lbOn">Upload Image</a></div>
                              <asp:Image ID="Image1" runat="server" ImageUrl="~/users/img/_MG_4845.JPG" 
                                  Width="191px" Height="194px" />
                        </td>
        </tr>
          <tr>
            <td height="30" style="padding:0px 7px 0px 7px;"><a href="http://student.monstercollege.in/stu_resume.html?rand=1430239790" class="lftnavlink">Profile</a></td>
          </tr>
                  <tr>
            <td height="30" bgcolor="#e7e6e4" style="padding:0px 7px 0px 7px;"><div style="float:left; "><a href="http://student.monstercollege.in/career_services/career_services.html?.rand=1430239790&service=VS" class="lftnavlink">Career Services</a></div></td>
          </tr>
                  <tr>
            <td height="30" bgcolor="#e7e6e4" style="padding:0px 7px 0px 7px;"><div style="float:left; "><a href="http://student.monstercollege.in/assessment.html?rand=1430239790" class="lftnavlink">Assessment</a></div></td>
          </tr>
                   <tr>
            <td height="30" bgcolor="#e7e6e4" style="padding:0px 7px 0px 7px;"><div style="float:left; "><a href="http://student.monstercollege.in/notification.html?rand=1430239790" class="lftnavlink">Updates</a></div></td>
          </tr>
          <tr>
            <td height="30" bgcolor="#e7e6e4" style="padding:0px 7px 0px 7px;"><div style="float:left; "><a href="http://student.monstercollege.in/my_messages.html?rand=1430239790" class="lftnavlink">Messaging</a></div></td>
          </tr>
                  <tr>
            <td height="30" bgcolor="#e7e6e4" style="padding:0px 7px 0px 7px;"><a href="http://student.monstercollege.in/applied_history.html?rand=1430239790" class="lftnavlink">Applied History</a></td>
          </tr>
          <tr>
            <td height="30" bgcolor="#e7e6e4" style="padding:0px 7px 0px 7px;"><a href="http://student.monstercollege.in/website.html?rand=1430239790" class="lftnavlink">Know More</a></td>
          </tr>
           
          <!--<tr>
         <td height="30" bgcolor="#e7e6e4" style="padding:0px 7px 0px 7px;"><span class="lftnavlink"><b><f3>Mock Test</f3></b></span> </td>
       </tr>-->
          <tr>
            <td height="30" style="padding:0px 7px 0px 7px;">
                <asp:Image ID="Image4" runat="server" ImageUrl="~/images/banner_vskill.gif" />
              </td>
          </tr>
      </tbody></table></td>
                <td class="style1" colspan="3"><div id="pane2"><table width="300" border="0" align="center" cellpadding="10" cellspacing="0">
                  <tbody><tr>
...
<!-- End Form For College Login -->
                  ...
                  </tbody></table></div>&nbsp;</a><span class="style5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                    Personal Information</span><table style="margin: 10px 10px 10px 20px;" 
  ...
  <tr>
    <td colspan="3" class="bold" height="15"></td>
    </tr>
        <tr>
         <td class="bold" style="font-size: 18px;" width="26%" height="30">Full Name</td>
    <td class="bold" width="2%" colspan="2" style="font-size: 18px; width: 74%;">:Prathamesh 
        Jadhav</td>
    </tr>
        <tr>
    <td class="bold" style="font-size: 18px;" width="26%">&nbsp;</td>
    <td class="bold" width="2%" colspan="2" style="font-size: 18px; width: 74%;">&nbsp;</td>
  </tr>
  <tr>
    <td class="bold" style="font-size: 18px;" width="26%" height="30"><span class="txt_red">*</span>Name</td>
    <td class="bold" width="2%" style="font-size: 18px">:</td>
    <td width="72%" style="font-size: 18px">
        <asp:Label ID="Label4" runat="server" Text="Prathamesh Jadhav"></asp:Label>
        </td>
  </tr>
          <tr>
    <td class="bold" style="font-size: 18px;" height="30" width="26%"><span class="txt_red">*</span>Email  Id</td>
    <td class="bold" width="2%" style="font-size: 18px">:</td>
    <td width="72%" style="font-size: 18px"><a href="mailto:amljadhav77@gmail.com">
        amljadhav77@gmail.com</a></td>
  </tr>
                <tr id="tr_update_email"><td height="30" width="26%" style="font-size: 18px">Address</td>
                    <td width="2%" style="font-size: 18px">:</td><td style="font-size: 18px">Room No 
                    :234</td>
      </tr>
        <tr style="display:none" id="tr_enter_email">
        <td class="bold" style="font-size: 18px;" height="30" width="26%">&nbsp;</td>
        <td class="bold" width="2%" style="font-size: 18px">&nbsp;</td>
        <td width="72%" style="font-size: 18px">KoperKhairane</td>
      </tr>
 <tr>
    <td class="bold" style="font-size: 18px;" width="26%">&nbsp;</td>
    <td class="bold" width="2%" style="font-size: 18px">&nbsp;</td>
    <td width="72%" style="font-size: 18px">
          Navi Mumbai 400709</td>
  </tr>
  <tr>
    <td class="bold" height="30" style="font-size: 18px;"><span class="txt_red">*</span>Contact No.</td>
    <td class="bold" style="font-size: 18px">:</td>
    <td style="font-size: 18px">
        9869845900</td>
  </tr>
   <tr>
    <td height="25" colspan="3" class="f14 txt_purple bold" style="font-size: 18px">College Details</td>
  </tr>
  <tr>
    <td height="1" colspan="3" bgcolor="#cccccc" style="font-size: 18px"></td>
  </tr>
  <tr>
    <td height="10" colspan="3" class="bold" style="font-size: 18px"></td>
  </tr>
  <tr>
    <td class="bold" style="font-size: 18px;" width="26%" height="30"><span class="txt_red">*</span>State</td>
    <td class="bold" width="2%" style="font-size: 18px">:</td>
    <td width="72%" style="font-size: 18px">
        Maharashtra</td>
  </tr>
  <tr>
                        <td class="bold" style="font-size: 18px;" width="26%" height="30"><span class="txt_red">*</span>City</td>
    <td class="bold" width="2%" style="font-size: 18px">:</td>
    <td width="72%" id="coll_city_select" style="font-size: 18px">
        Mumbai</td>
  </tr>
  <tr>
    <td class="bold" style="font-size: 18px;" height="30" width="26%"><span class="txt_red">*</span>College Name</td>
    <td class="bold" width="2%" style="font-size: 18px">:</td>
    <td width="72%" id="choose_college" style="font-size: 18px">ycc</td>
                </tr>
  <tr><td colspan="3" id="branch_deg" style="font-size: 18px"><table style="margin: 0px 10px 0px 0px;" align="left" border="0" cellpadding="0" cellspacing="0" width="93%">
<tbody><tr>
    <td class="bold" style="padding-left: 15px;" width="28%" height="30"><span class="txt_red">*</span>Degree</td>
    <td class="bold" width="2%">:</td>
    <td width="70%">
	&nbsp;BSC</td>
  </tr>
 <tr>
	<td colspan="3" id="branch_select">
		<table style="margin: 0px 10px 0px 0px;" align="left" border="0" cellpadding="0" cellspacing="0" width="93%">
			<tbody><tr>
				<td class="bold" style="padding-left: 15px;" width="30%" height="30"><span class="txt_red">*</span>Branch</td>
    <td class="bold" width="2%">:</td>
    <td width="68%">
	&nbsp;I.T.</td>
			</tr>
  ...
  <tr>
    <td class="bold" style="font-size: 18px;" height="30" width="26%"><span class="txt_red">*</span>University Roll no.</td>
    <td class="bold" width="2%" style="font-size: 18px">:</td>
    <td width="72%" style="font-size: 18px">&nbsp;ES370</td>
  </tr>
  <tr>
    <td class="bold" style="font-size: 18px;" height="30"><span class="txt_red">*</span>Joining Year</td>
    <td class="bold" width="2%" style="font-size: 18px">:</td>
    <td style="font-size: 18px">
        2011</td>
  </tr>
  <tr>
    <td class="bold" style="font-size: 18px;" height="30" width="26%"><span class="txt_red">*</span>Year of Passing</td>
    <td class="bold" width="2%" style="font-size: 18px">:</td>
    <td width="72%" style="font-size: 18px">
        2015</td>
  </tr>
  <tr>
    <td colspan="3" height="15" style="font-size: 18px"></td>
  </tr>
  <tr>
    <td colspan="3" class="f14 txt_purple bold" height="25" style="font-size: 18px">Education  Background</td>
    </tr>
 
  <tr>
    <td colspan="3" bgcolor="#cccccc" height="1" style="font-size: 18px"></td>
  </tr>
  <tr>
    <td colspan="3" class="bold" height="15" style="font-size: 18px"></td>
  </tr>
<tr>
    <td colspan="3" style="font-size: 18px;" height="25"><table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody><tr>
                <td width="8%" style="padding:5px; padding-left:0px; border-bottom:solid 1px #bfbfbf;"><strong>Course</strong></td>
        <td width="27%" style="padding:5px; border-bottom:solid 1px #bfbfbf;"><strong>School/University</strong></td>
        <td width="14%" style="padding:5px; border-bottom:solid 1px #bfbfbf;"><strong>Stream</strong></td>
                <td width="15%" nowrap="nowrap" style="padding:5px; border-bottom:solid 1px #bfbfbf;"><strong>Year of Passing</strong></td>
        <td width="11%" style="padding:5px; border-bottom:solid 1px #bfbfbf;"><strong>Percentage</strong></td>
        <td width="11%" style="padding:5px; border-bottom:solid 1px #bfbfbf;"><strong>Status</strong></td>
        <td class="bold" width="15%" style="padding:5px; border-bottom:solid 1px #bfbfbf;">&nbsp;</td>
      </tr>

<tr>
                <td style="padding:5px; padding-left:0px;"><span class="txt_red">*</span>Xth</td>
        <td height="25">
                PUNE
...
<tr>
              <td style="padding:5px; padding-left:0px;"><span class="txt_red">*</span>XIIth</td>
                <td height="25">
                        PUNE</td>
        <td>
                        SCIENCE</td>
        ...
        <tr>
              <td style="padding:5px; padding-left:0px;">Diploma</td>
                <td height="25">
                        KOPLHAPUR</td>
        <td>
                        SCIENCE</td>
        ...
        <tr id="grad_div_pre" class="">
              <td style="padding:5px; padding-left:0px;"><span class="txt_red">*</span>Grad
                <input type="hidden" name="profile_PG_Check" id="profile_PG_Check" value="UG"></td>
                <td height="25">
                        MUMBAI</td>
        <td>
                        COMMERCE</td>
   ...
   <tr id="grad_div_pre1" class=""><td nowrap="nowrap" colspan="4" style="padding:0px 0px; padding-left:0px;padding-left:5px;">
       &nbsp;</td><td nowrap="nowrap" colspan="3" style="padding:0px 0px; padding-left:0px; padding-left:5px; valign=">
           &nbsp;</td></tr>
    <tr id="grad_div" style="display:none;" class="bg_grey">
               <td style="padding:5px; padding-left:0px;"><span class="txt_red">*</span>PG</td>
                <td height="25">
                        MUMBAI</td>
                <td colspan="5">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               
                        <span id="pg_year_pass_dn" name="pg_year_pass_dn"></span>
                </td>
   </tr>
     <tr id="pg_div_pre" style="display:none;"><td nowrap="nowrap" colspan="7" 
             class="bg_grey" 
             style="padding:0px 0px; padding-left:0px; border-left:solid 1px #bfbfbf; padding-left:5px;">
         &nbsp;</td></tr>
</tbody></table></td>
  </tr>
  <tr id="pr_verify">
    <td class="bold" style="font-size: 18px;" align="left" height="25" valign="top">Profile  Status</td>
    <td class="bold" style="font-size: 18px">:</td>
    <td width="300" style="font-size: 18px">Incomplete</td>
  </tr>
  <tr>
    <td colspan="3" class="bold" height="15" style="font-size: 18px"></td>
  </tr>
   <tr>
    <td height="30" class="bold" style="font-size: 18px;">Education  Gap (If Any)</td>
    <td height="25" class="bold" style="font-size: 18px">:</td>
    <td height="25" class="bold" style="font-size: 18px">&nbsp;<asp:Label ID="Label37" 
  ...
  <tr>
    <td height="25" align="left" valign="top" class="bold" style="padding-left:15px;">Previous Work Experience</td>
    <td width="3%" valign="top" class="bold">:</td>
    <td><div style="float:left;">&nbsp;<asp:Label ID="Label38" runat="server" 
            Text="Label"></asp:Label>
        </div><div style="margin-left:10px; float:left; display:none;" id="exp_year"><select name="no_of_years" id="no_of_years">
   ...
   <tr style="display:none;" id="exp_details">
    <td class="bold" style="padding-left: 15px;" align="left" height="25" valign="top"></td>
     <td width="3%" valign="top" class="bold"></td>
    <td>
                &nbsp;<input type="hidden" name="work_details_edit" id="work_details_edit" value=""></td>
  </tr>
  <tr align="left" valign="top">
    <td height="15" colspan="3"></td>
  </tr>
<tr>
  <td height="25" align="left" valign="top" class="bold" style="padding-left:15px;">Skills</td>
  <td width="2%" valign="top" class="bold">:</td>
  <td>
      <asp:Label ID="Label39" runat="server" Text="Label"></asp:Label>
    </td>                                              
</tr>
  <tr>
    <td class="bold" style="padding-left: 15px;" align="left" height="25" valign="top">Voluntary Experience</td>
    <td class="bold" width="2%" valign="top">:</td>
    <td>
                &nbsp;<input type="hidden" name="experience_edit" id="experience_edit" value=""><asp:Label 
                    ID="Label40" runat="server" Text="Label"></asp:Label>
        </td>
  </tr>
  <tr align="left" valign="top">
  ...
  <tr>
    <td class="bold" style="padding-left: 15px;" align="left" height="25" valign="top">Interest and Hobbies</td>
    <td class="bold" width="2%" valign="top">:</td>
    <td>
                &nbsp;<input type="hidden" name="interest_edit" id="interest_edit" value=""><asp:Label 
                    ID="Label41" runat="server" Text="Label"></asp:Label>
        </td>
  </tr>
  <tr>
    <td colspan="3" class="f14 txt_purple bold" height="25">Personal Informations</td>
  </tr>
  ...
  <tr>
    <td class="bold" style="padding-left: 15px;" height="30" valign="top"><span class="txt_red">*</span>Father’s Name</td>
    <td class="bold" width="2%" valign="top">:</td>
    <td valign="top">
  ...
  <tr>
    <td class="bold" style="padding-left: 15px;" height="30" valign="top">Mother’s Name</td>
    <td class="bold" width="2%" valign="top">:</td>
    <td valign="top">
...
<tr>
    <td class="bold" style="padding-left: 15px;" height="30" valign="top"><span class="txt_red">*</span>Gender</td>
    <td class="bold" width="2%" valign="top">:</td>
    <td valign="top">
  ...
  <tr>
    <td class="bold" style="padding-left: 15px;" height="30" valign="top"><span class="txt_red">*</span>Date Of Birth</td>
    <td class="bold" width="2%" valign="top">:</td>
    <td valign="top">
  ...
  <tr>
    <td height="30" valign="top" class="bold" style="padding-left:15px;"> Address</td>
  ...
  <tr>
    <td class="bold" style="padding-left: 15px;" height="30" valign="top">Languages Known</td>
    <td class="bold" width="2%" valign="top">:</td>
    <td valign="top">
  ...
  <tr>
    <td class="bold" style="padding-left: 15px;" height="30" valign="top"><span class="txt_red">*</span>Nationality</td>
    <td class="bold" width="2%" valign="top">:</td>
    <td valign="top">
  ...
  <tr>
    <td class="bold" style="padding-left: 15px;" height="30" valign="top">Blood Group</td>
    <td class="bold" width="2%" valign="top">:</td>
    <td valign="top">
   ...
   <tr>
      <td height="40" class="bold" style="padding-left:15px;">Passport  No, If Availiable</td>
          <td width="3%"><span class="bold f12">:</span></td>
          <td>
              <asp:Label ID="Label50" runat="server" Text="Label"></asp:Label>
       </td>
        </tr>
        <tr>
        <td height="40" class="bold " style="padding-left:15px;">PAN  Card No, If Availiable</td>
         <td width="3%"><span class="bold f12">:</span></td>
       <td>
  ...
  <tr>
    <td colspan="3" bgcolor="#cccccc" height="1"><input type="hidden" name="is_edited" id="is_edited" value="1"></td>
  </tr>
  <tr>
    <td colspan="3" class="bold" align="center" height="50">
        &nbsp;<div id="syntl_msg" style="display:none"><font color="red">Student Registration / Modification  is closed for Syntel Campus Drive - 2013 batch.</font></div>
      </td>
  </tr>
</tbody></table></td>
                <td width="100" class="style1"><div id="pane3"><table width="300" border="0" align="center" cellpadding="8" cellspacing="0">
                  <tbody><tr>
...
<!-- End Form For Corporate Login -->
  ...
  <div style="float:right; font-weight:bold; margin:0px; padding:0px;">For any feedback <a href="" style="color:#FFF;">Contact us</a></div></td>
              ...
              <tr>
                <td class="style4"><map name="Map" id="Map"><area shape="rect" coords="8,64,67,94" href=""><area shape="poly" coords="1,0,321,2,318,96,138,94,136,57,2,57" href="" >
&nbsp;</map></td>
                <td>&nbsp;</td>
                <td valign="top">
                    </a></td>
