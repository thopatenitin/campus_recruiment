<%@ Page Language="C#" AutoEventWireup="true" CodeFile="inbox.aspx.cs" Inherits="users_inbox" %>
     ...
     <tbody><tr>
       <td>
         <div class="accordion2">
           <table border="0" cellspacing="0" cellpadding="0" style="width: 1094px">
             <tbody><tr>
               <td class="style3" valign="top" width="150">
...
<!-- End Form For Student Login -->
                   ...
                   <table style="border-top: 1px solid rgb(146, 146, 146); border-left: 1px solid rgb(146, 146, 146); border-bottom: 1px solid rgb(146, 146, 146); width: 201px;" 
...
<!-- End Form For Corporate Login -->
  ...
  <div style="float:right; font-weight:bold; margin:0px; padding:0px;">For any feedback <a href="" style="color:#FFF;">Contact us</a></div></td>
                  ...
                  </tbody></table></div>&nbsp;</a><asp:Image ID="Image5" runat="server" 
                        Height="595px" ImageUrl="~/images/Capture.JPG" style="margin-left: 13px" 
                        Width="926px" />
                 </td>
                </tr>
