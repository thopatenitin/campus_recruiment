<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Apllyone1.aspx.cs" Inherits="users_Apllyone1" %>
...
<!-- End Form For Corporate Login -->
  ...
  <div style="float:right; font-weight:bold; margin:0px; padding:0px;">For any feedback <a href="" style="color:#FFF;">Contact us</a></div></td>
                        ...
                        &nbsp;</td><td width="800" align="center" valign="middle">
                            <span class="style2">Apply Online</span><br />
    ...
    <tr><td class="style7">
        <asp:Image ID="Image7" runat="server" Width="100px" 
            ...
            <asp:Label ID="Label8" runat="server">TECHNICAL EXICUTIVE OFFICER</asp:Label>
    ...
    <tr><td>
        <asp:Image ID="Image8" runat="server" Width="100px" EnableTheming="False" 
            ...
            <asp:Button ID="Button7" runat="server"  Text="Apply Now" 
                 BackColor="White" BorderWidth="1px" />
        </td></tr>
    </table></td>
                </tr>
