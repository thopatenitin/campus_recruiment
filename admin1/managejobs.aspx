<%@ Page Language="C#" AutoEventWireup="true" CodeFile="managejobs.aspx.cs" Inherits="CampusRecruiment.admin.managejobs" %>
...
<!-- End Form For Student Login -->
        ...
        <tbody><tr>
          ...
          <tr>
            <td height="30" bgcolor="#e7e6e4" style="padding:0px 7px 0px 7px;"><a href="./">
                Manage Jobs</a></td>
          </tr>
          ...
          <tr>
            <td height="30" style="padding:0px 7px 0px 7px;">
                <asp:Image ID="Image4" runat="server" 
                    ImageUrl="~/images/180x180_students3.gif" />
              </td>
          </tr>
      </tbody></table></td>
...
<!-- End Form For Corporate Login -->
  ...
  <div style="float:right; font-weight:bold; margin:0px; padding:0px;">For any feedback <a href="" style="color:#FFF;">Contact us</a></div></td>
                  ...
                  </tbody></table></div>&nbsp;</a><table style="height: 526px; width: 734px"><tr>
                        <td class="style5" valign="top">
                            <asp:Panel ID="Panel1" runat="server" Height="619px">
                                <table border="1"><tr><td align="center" class="style10" colspan="3">
                                    <span class="style9">Pending For Approval</span><br /> </td></tr>
    ...
    <tr><td>
        <asp:Image ID="Image6" runat="server" Width="100px" EnableTheming="False" 
            ...
            <asp:Button ID="Button6" runat="server"  Text="Approve" 
                 BackColor="White" BorderWidth="1px" />
        </td></tr>
    <tr><td>
        <asp:Image ID="Image8" runat="server" Width="100px" EnableTheming="False" 
            ...
            <asp:Button ID="Button7" runat="server"  Text="Approve" 
                 BackColor="White" BorderWidth="1px" />
        </td></tr>
    </table>
                            </asp:Panel>
