<%@ Page Language="C#" AutoEventWireup="true" CodeFile="home.aspx.cs" Inherits="CampusRecruiment.admin.home" %>
...
<!-- End Form For Corporate Login -->
  ...
  <div style="float:right; font-weight:bold; margin:0px; padding:0px;">For any feedback <a href="" style="color:#FFF;">Contact us</a></div></td>
                        ...
                        <td class="style5" valign="top"><span class="style7">Well Come </span>
                            <span class="style8">Mr. ADMINISTRATOR</span><br />
                            <asp:Panel ID="Panel1" runat="server" Height="554px">
                                <br />
                                #&nbsp; 15 Job Seekers are newely Registered
                                <br />
                                <br />
                                # 12 Job Provider are Waiting For Approval<br />
                                <br />
                                # Interview Locations&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <br />
                            </asp:Panel>
                        </td><td align="center" class="style6" valign="top">
