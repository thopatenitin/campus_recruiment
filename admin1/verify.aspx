<%@ Page Language="C#" AutoEventWireup="true" CodeFile="verify.aspx.cs" Inherits="CampusRecruiment.admin.verify" %>
...
<!-- End Form For College Login -->
                  ...
                  </tbody></table></div>&nbsp;<asp:Panel ID="Panel1" runat="server" Height="619px">
                                <table border="1" style="height: 642px"><tr><td align="center" class="style10" colspan="3">
                                    <span class="style8">Pending For Approval<br />
                                    <br />
                                    </span><br /> </td></tr>
                        <tr><td width="100" class="style5">
        <asp:Image ID="Image2" runat="server" Width="100px" ImageUrl="~/images/logo/download (3).jpg" />
        </td><td width="800" class="style5">
            <asp:Label ID="Label4" runat="server">PURCHASE MANAGER</asp:Label>
        </td><td width="200" align="center" class="style5">
            <asp:Button ID="Button2" runat="server"  Text="View Detail" 
                 BackColor="White" BorderWidth="1px"  />
        </td></tr>
    <tr><td class="style6">
        <asp:Image ID="Image3" runat="server" Width="100px" 
            ImageUrl="~/images/logo/download (5).jpg" />
        </td><td class="style6">
            <asp:Label ID="Label5" runat="server">MANAGER</asp:Label>
        </td><td align="center" class="style6">
            <asp:Button ID="Button3" runat="server"  Text="View Detail" 
                 BackColor="White" BorderWidth="1px" 
                EnableTheming="True" />
        </td></tr>
    <tr><td class="style7">
        <asp:Image ID="Image7" runat="server" Width="100px" 
            ImageUrl="~/images/logo/th (4).jpg" />
        </td><td class="style7">
            <asp:Label ID="Label8" runat="server" Font-Size="12pt">TECHNICAL EXICUTIVE OFFICER</asp:Label>
        </td><td align="center" class="style7">
            <asp:Button ID="Button4" runat="server"  Text="View Detail" 
                BackColor="White" BorderWidth="1px" />
        </td></tr>
    <tr><td>
        <asp:Image ID="Image5" runat="server" Width="100px" 
            ImageUrl="~/images/logo/download (1).jpg" Height="103px" />
        </td><td>
            <asp:Label ID="Label11" runat="server">MARKETING MANAGER</asp:Label>
        </td><td align="center">
            <asp:Button ID="Button5" runat="server"  Text="View Detail" 
                 BackColor="White" BorderWidth="1px" />
        </td></tr>
    <tr><td>
        <asp:Image ID="Image6" runat="server" Width="100px" EnableTheming="False" 
            ImageUrl="~/images/logo/th (1).jpg" Height="108px" />
        </td><td>
            <asp:Label ID="Label14" runat="server">GENERAL MANAGER</asp:Label>
        </td><td align="center">
            <asp:Button ID="Button6" runat="server"  Text="View Detail" 
                 BackColor="White" BorderWidth="1px" />
        </td></tr>
    <tr><td>
        <asp:Image ID="Image8" runat="server" Width="100px" EnableTheming="False" 
            ImageUrl="~/images/logo/th (8).jpg" Height="108px" />
        </td><td>
            <asp:Label ID="Label15" runat="server">SENIOR EXICUTIVE OFFICER</asp:Label>
        </td><td align="center">
            <asp:Button ID="Button7" runat="server"  Text="View Detail" 
                 BackColor="White" BorderWidth="1px" />
        </td></tr>
    </table>
                            </asp:Panel></td>
