<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manageuser.aspx.cs" Inherits="CampusRecruiment.admin.manageuser" %>
        ...
        <tbody><tr>
          ...
          <tr>
            <td height="30" bgcolor="#e7e6e4" style="padding:0px 7px 0px 7px;"><div style="float:left; "><a href="http://student.monstercollege.in/my_messages.html?rand=1430239790" class="lftnavlink">Messaging</a></div></td>
                  ...
                  <tr>
            <td height="30" bgcolor="#e7e6e4" style="padding:0px 7px 0px 7px;">
...
<!-- End Form For Corporate Login -->
  ...
  <div style="float:right; font-weight:bold; margin:0px; padding:0px;">For any feedback <a href="" style="color:#FFF;">Contact us</a></div></td>
                  ...
                  </tbody></table></div>&nbsp;</a><table border="1"><tr><td width="100">
                        &nbsp;</td>
                        <td align="center" valign="middle" class="style9">
                            <span class="style8">User Administration<br />
                            </span><br />
        </td><td align="center" valign="middle" class="style13">
                            &nbsp;</td><td width="80" align="center">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                            &nbsp;</td></tr>
                        <tr><td width="100" class="style5">
        <asp:Image ID="Image2" runat="server" Width="100px" ImageUrl="~/users/img/IMG-20150105-WA0031.jpg" 
                                Height="108px" />
        </td><td class="style10">
            <asp:Label ID="Label4" runat="server">Shravan Hali ; Mumbai Univercity</asp:Label>
        </td><td class="style14">
                                <asp:DropDownList ID="DropDownList1" runat="server">
                                    <asp:ListItem>Take Ofline</asp:ListItem>
                                    <asp:ListItem>Remove</asp:ListItem>
                                    <asp:ListItem>Mark as Spam</asp:ListItem>
                                    <asp:ListItem>Mark For Approval</asp:ListItem>
                                </asp:DropDownList>
        </td><td width="80" align="center" class="style5">
            <asp:Button ID="Button2" runat="server"  Text="Update" 
                 BackColor="White" BorderWidth="1px" onclick="Button2_Click"   />
        </td></tr>
    <tr><td class="style6">
        <asp:Image ID="Image3" runat="server" Width="100px" 
            ImageUrl="~/users/img/_MG_4786.JPG" />
        </td><td class="style11">
            <asp:Label ID="Label5" runat="server">Vikas Kharat ; Mumbai Univercity</asp:Label>
        </td><td class="style15">
        ...
        </td><td align="center" class="style6" width="80">
            <asp:Button ID="Button3" runat="server"  Text="Update" 
                 BackColor="White" BorderWidth="1px" 
                EnableTheming="True" />
        </td></tr>
    <tr><td class="style7">
        <asp:Image ID="Image7" runat="server" Width="100px" 
            ImageUrl="~/users/img/_MG_4845.JPG" />
        </td><td class="style12">
            <asp:Label ID="Label8" runat="server">Kalpesh Jadhav ; Mumbai Univercity</asp:Label>
        </td><td class="style16">
        ...
        </td><td align="center" class="style7" width="80">
            <asp:Button ID="Button4" runat="server"  Text="Update" 
                BackColor="White" BorderWidth="1px" />
        </td></tr>
    <tr><td>
        <asp:Image ID="Image5" runat="server" Width="100px" 
            ImageUrl="~/users/img/29102010160.jpg" Height="103px" />
        </td><td class="style9">
            <asp:Label ID="Label11" runat="server">Dinesh Navrat ; Mumbai Univercity</asp:Label>
        </td><td class="style13">
    ...
    <tr><td>
        <asp:Image ID="Image6" runat="server" Width="100px" EnableTheming="False" 
            ImageUrl="~/users/img/IMG-20150105-WA0013.jpg" Height="108px" />
        </td><td class="style9">
            <asp:Label ID="Label14" runat="server">Rakesh Maria ; Mumbai Univercity</asp:Label>
        </td><td class="style13">
    ...
    <tr><td>
        <asp:Image ID="Image8" runat="server" Width="100px" EnableTheming="False" 
            ImageUrl="~/users/img/_MG_4810.JPG" Height="108px" />
        </td><td class="style9">
            <asp:Label ID="Label15" runat="server">Akash Kharat ; Kolhapure Univercity</asp:Label>
        </td><td class="style13">
